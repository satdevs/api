				...
				<?= $this->Form->create($invoice, ['id' => 'main-form', 'class'=>'form-horizontal']) ?>
					...
					<div class="card-body" style="opacity: 0;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<?php echo $this->Form->control('user_id', ['options' => $myUsers, 'class' => 'selectpicker form-control string', 'title' => 'Kérem válasszon...', 'data-live-search' => 'true', 'data-actions-box' => 'true', 'label' => false, 'empty' => true, 'required' => true]); ?>
							</div>
						</div>
